export const STAGE_WAVES = [
  [
    ...
    { delay: 1.0, type: ["striker", "scout", "scout"], count: 5, interval: 0.46, formation: "centerGuard", message: "中型敌机护航" },
    { delay: 1.0, type: ["elite", "weaver", "weaver"], count: 5, interval: 0.42, formation: "elitePress", message: "精英小队压场" },
    { delay: 1.0, type: ["bomber", "scout"], count: 6, interval: 0.42, formation: "leftRight", message: "自爆机混入" },
    { delay: 1.0, type: ["sentry", "scout"], count: 5, interval: 0.5, formation: "centerGuard", message: "哨戒机压制" },
    { delay: 1.0, type: ["weaver", "striker"], count: 7, interval: 0.38, formation: "vshape", message: "V 字突袭" },
    { delay: 1.2, type: "miniBoss", count: 1, interval: 1, formation: "line", message: "MINI BOSS / 轨道重卫" },
    { delay: 1.0, type: ["bomber", "weaver"], count: 7, interval: 0.34, formation: "cross", message: "追击自爆群" },
